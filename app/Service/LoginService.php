...
class LoginService
{
    ...
    public function __construct(public User $car){}
        ...
        public function login($data)
    {
        ...
        if($user->email_verified_at == null){
            throw new InsuranceNotFoundException(__('The user account has not been verified yet', [], Request()->header('Accept-language')));
        }
